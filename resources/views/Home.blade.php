                                    ...
                                    <ul class="nav navbar-nav flex-row ml-auto">
												...
												{{-- @foreach (Auth::user()->unreadNotifications as $notification)
													<li>
														<a href="#">
															...
															<br>
															Professeur: {{ $notification->data['professeur_name'] }}
															<br>
															Admin: {{ $notification->data['admin_name'] }}
															<br>
                                        ...
                                        <li class="dropdown nav-item">
                                            <a class="nav-link" href="#" data-toggle="dropdown">
                                                ...
                                                <img id="profileimage"
                                                    src="{{ Auth::check() && Auth::user()->image ? asset('storage/' . Auth::user()->image) : asset('assets/icon.jpg') }}"
