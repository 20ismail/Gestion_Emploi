                    ...
                    <div class="row">
                        <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
                            <div class="container light-style flex-grow-1 container-p-y">
                                <form action="{{ route('updateProfile') }}"
                                            ...
                                            <div class="col-md-3 pt-0">
                                                <div class="list-group list-group-flush account-settings-links">
                                                    ...
                                                    <a class="list-group-item list-group-item-action"
                                                        data-toggle="list" href="#account-change-password">Modifier
                                                        password</a>
                                                </div>
                                            </div>
                                            <div class="col-md-9">
                                                    ...
                                                    <div class="tab-pane fade active show" id="account-general">
                                                            ...
                                                            function previewImage() {
                                                                ...
                                                                if (file) {
                                                                    ...
                                                                    fileReader.onload = function(event) {
                                                                        document.getElementById("imagePreviewContainer").getElementsByTagName('img')[0].src = event.target.result;
                                                                    };
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="form-label">Veuillez Entrer Votre Nom
                                                                </label>
                                                                <input type="text" name="nom"
                                                                    class="form-control mb-1"value="{{ $user->nom }}">


                                                            </div>
                                                            <div class="form-group">
                                                                <label class="form-label">Veuillez Entrer Votre
                                                                    Prenom</label>
                                                                <input type="text"
                                                                    name="prenom"class="form-control mb-1"
                                                                    value="{{ $user->prenom }}">

                                                            </div>
                                                            <div class="form-group">
                                                                <label class="form-label">Veuillez Entrer Votre Numero
                                                                    telephone </label>
                                                                <input type="number"
                                                                    name="numTelephone"class="form-control mb-1"
                                                            ...
                                                            <div class="form-group">
                                                                <label class="form-label">Veuillez Entrer Votre
                                                                    heuresAnnee </label>
                                                                <input type="number"
                                                                    name="heuresEnseignementAnnee"class="form-control mb-1"
                                                                    value="{{ $user->heuresEnseignementAnnee }}">
