					     ...
					     <div class="xp-profilebar text-right">
						    <nav class="navbar p-0">
							   ...
							   <li class="dropdown nav-item">
                                <a class="nav-link" href="#" data-toggle="dropdown">
                                    <img id="profileimage" src="{{ Auth::user()->profileimage ? asset('storage/' . Auth::user()->profileimage) : asset('assets/icon.jpg') }}" style="width: 40px; height: 40px; object-fit: cover; border-radius: 50%;">								  </a>
...
@endif
                                                <h3 class="bienv">
                                                    Bienvenue Dans votre Espace Personnelle
                                                </h3>
                                                        ...
                                                        <div class="col-md-3 pt-0">
                                                            <div class="list-group list-group-flush account-settings-links">
                                                                ...
                                                                <a class="list-group-item list-group-item-action" data-toggle="list"
                                                                    href="#account-change-password">Modifier password</a>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-9">
                                                                ...
                                                                <div class="tab-pane fade active show" id="account-general">
                                                                        ...
                                                                        <div class="card-body media align-items-center">
                                                                            <div id="imagePreviewContainer" class="image-container">
                                                                                <img src="{{ asset('storage/' . Auth::user()->profileimage)}}" alt="^" class="user-avatar rounded-circle">
                                                                            </div>
                                                                        ...
                                                                        <script>
                                                                            document.getElementById('profileimage').onchange = function(event) {
                                                                                ...
                                                                                reader.onload = function() {
                                                                                    var output = document.getElementById('imagePreviewContainer').getElementsByTagName('img')[0];
                                                                    ...
                                                                    <div class="card-body">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label class="form-label">Veuillez Entrer Votre Nom </label>
                                                                            <input type="text" name="nom" class="form-control mb-1"value="{{ $user->nom }}">


                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label class="form-label">Veuillez Entrer Votre Prenom</label>
                                                                            <input type="text" name="prenom"class="form-control mb-1"value="{{ $user->prenom }}">

                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label class="form-label">Veuillez Entrer Votre Matiere</label>
                                                                            <div class="checkbox">
                                                                                <label><input class="form-control mb-1" type="checkbox" name="matiere[]" value="reseaux" {{ in_array('reseaux', old('matiere', explode(',', Auth::user()->matiere))) ? 'checked' : '' }}> reseaux</label>
                                                                            </div>
                                                                            <div class="checkbox">
                                                                                <label><input class="form-control mb-1" type="checkbox" name="matiere[]" value="analyse numerique" {{ in_array('analyse numerique', old('matiere', explode(',', Auth::user()->matiere))) ? 'checked' : '' }}> analyse numerique</label>
                                                                            </div>
                                                                            <div class="checkbox">
                                                                                <label><input class="form-control mb-1" type="checkbox" name="matiere[]" value="algebre" {{ in_array('algebre', old('matiere', explode(',', Auth::user()->matiere))) ? 'checked' : '' }}> algebre</label>
                                                                            </div>
                                                                            <div class="checkbox">
                                                                                <label><input  class="form-control mb-1" type="checkbox" name="matiere[]" value="web" {{ in_array('web', old('matiere', explode(',', Auth::user()->matiere))) ? 'checked' : '' }}> web</label>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label class="form-label">Veuillez Entrer Votre E-mail</label>
                                                                            <input  class="form-control mb-1" type="email" name="email" value="{{ old('email', $user->email) }}" required>
                                                                    ...
                                                                    <div class="card-body pb-2">
                                                                        ...
                                                                        <script>
                                                                            ...
                                                                            document.querySelector('form').addEventListener('submit', function(event) {
                                                                                ...
                                                                                var confirmNewPassword = document.querySelector('[name="new_password_confirmation"]').value;
