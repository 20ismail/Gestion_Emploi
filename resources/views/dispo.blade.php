                        ...
                        <div class="table-wrapper">
                            ...
                            <form action="{{ route('dispo') }}" method="POST">
                                ...
                                @foreach (['semestre1', 'semestre2'] as $semestre)
                                    <div id="table-{{ $semestre }}" class="semestre-table"
                                        style="display: none;">
...
@endforeach
                                ...
                                <script>
                                    document.getElementById('semestre').addEventListener('change', function() {
                                        ...
                                        var tables = document.querySelectorAll('.semestre-table');
                                        ...
                                        if (selectedValue) {
                                            document.getElementById('table-' + selectedValue).style.display = 'block';
                                        }
                                    });
                                </script>
                                <div class="table-actions"
                                    style="position: fixed; margin-right:10px; margin-top:10px; bottom: 0; width: 100%; background: #f8f9fa; padding: 10px; text-align: center; box-shadow: 0 -2px 5px rgba(0,0,0,0.1);">
                                    <button type="submit" formaction="{{ route('dispo.store') }}"
                                        class="btn btn-primary btn-sm">
                                        <i class="fas fa-plus"></i> Ajouter
                                    </button>
                                    <button type="submit" formaction="{{ route('dispo.update') }}"
