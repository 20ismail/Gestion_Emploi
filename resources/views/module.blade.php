                                ...
                                <nav class="navbar p-0">
                                    <ul class="nav navbar-nav flex-row ml-auto">
                                        ...
                                        <li class="dropdown nav-item">
                                            <a class="nav-link" href="#" data-toggle="dropdown">
                                                <img id="profileimage"
                                                    src="{{ Auth::user()->profileimage ? asset('storage/' . Auth::user()->profileimage) : asset('assets/icon.jpg') }}"
            ...
            <div class="container">
				<form id="moduleForm" method="POST" action="{{ route('module.store') }}">
					...
					<div class="col-md-3">
						...
						<select class="form-control" id="cycle" name="semestre">
					...
					<div class="col-md-3">
						...
						<select class="form-control" id="module" name="module" onchange="showActivityOptions()">
							<option value="">Sélectionner</option>
							<option value="reseau">Réseau</option>
							<option value="administration_reseau">Administration Réseau</option>
					...
					<div id="activitySelection" style="display:none;">
						<div class="form-group">
							...
							<select class="form-control" id="activityType" name="activity_type" onchange="showGroupOptions()">
								<option value="">Sélectionner</option>
